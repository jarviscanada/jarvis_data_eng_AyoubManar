...
###### Question 2: Adding a new facility - a spa
...
###### Question 3: Adding a new facility - with automatic value for the next facid
...
```
###### Question 5:  Alter the price of the second tennis court so that it costs 10% more than the first one
